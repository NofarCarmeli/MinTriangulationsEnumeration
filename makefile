...
_OBJ = IndSetExtByTriangulation.o IndSetExtBySeparators.o IndSetScorerByTriangulation.o MinimalSeparatorsEnumerator.o MinimalTriangulationsEnumerator.o GraphReader.o MinimalTriangulator.o Graph.o DataStructures.o SeparatorGraph.o Converter.o SeparatorsScorer.o ChordalGraph.o SubGraph.o ResultsHandler.o main.o 
